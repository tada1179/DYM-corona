...
function new()
    ...
    local imageName = "img/framCharacterIcon/as_cha_frm05.png"
    local imagePicture = "img/framCharacterIcon/as_cha_icon_test5001.png"
    ...
    for i = 3, 5, 1 do
        ...
        --local imageName = "as_cha_frm05.png"
    ...
    local message = display.newText("team 5/5", 0, 0, native.systemFontBold, 16)
