...
local function GameOption(option)
    ...
    SKL =  gameOption.SKL
    checkOption =  2
    print("GameOption mission"..mission,"battle"..battle, "BGM"..BGM,"SFX"..SFX,"SKL"..SKL,"BTN"..BTN,"checkOption"..checkOption)
    ...
    local function ButtouON_Off(event)
        ...
        print("event.target.id ButtouON_Off = mission"..mission,"battle"..battle, "BGM"..BGM,"SFX"..SFX,"SKL"..SKL,"BTN"..BTN,"checkOption"..checkOption)
...
local function MenuInPuzzle(option)
    ...
    print("000MenuInPuzzle mission"..mission,"battle"..battle, "BGM"..BGM,"SFX"..SFX,"SKL"..SKL,"BTN"..BTN,"checkOption"..checkOption)
...
local function createBackButton(event)
    ...
    print("000 gameoption:",gameoption)
    if gameoption then
        mission = gameoption.mission
        battle = gameoption.battle
        BGM = gameoption.BGM
  ...
  -------tada1179.w@gmail.com
    ...
    local imgCharacter = "img/character/TouTaku-v101.png"
    local characImage = display.newImageRect(imgCharacter,_W*.3, _H*.2)
    characImage:setReferencePoint( display.CenterReferencePoint )
    characImage.x = _W*.5
    characImage.y = _H*.18
    --loadImage()
 -------tada1179.w@gmail.com
    ...
    local function ButtouMenu(event)
        ...
        if (event.phase == "ended" or event.phase == "release") then
            if event.target.id == "Menu"  then
                ...
                print("on click Menu button mission"..mission,"battle"..battle, "BGM"..BGM,"SFX"..SFX,"SKL"..SKL,"BTN"..BTN,"checkOption"..checkOption)
                MenuInPuzzle(option)
...
function showImage()
    ...
    -- Display local file
    testImage = display.newImage("l.png",system.DocumentsDirectory,_W*.32,_H*.06);
end
...
function loadImage()
    ...
    local path = system.pathForFile( "l.png", system.DocumentsDirectory )
