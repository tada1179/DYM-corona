...
and friend.friend_respone = '$respone' ORDER BY RAND()LIMIT 2");
			...
			if($Mydatateam=mysql_fetch_array($datateam)){
				...
				");					
					...
					//echo "my friend";
						$json[]=array(  
						"No"=>$rowfriend, 
						 "holdcharac_id"=>$charac['holdcharac_id'], 
						 ...
						 "friend_element"=>$charac['charac_element'],  
...
where `friend`.user_id != '$myuser_id' 
and `friend`.friend_userid !='$myuser_id' ORDER BY  RAND()LIMIT 5 ";
			 ...
			 $datateam = mysql_query("SELECT team.*,hold_team.* FROM `hold_team` 
				...
				");					
					...
					//echo "no friend";
						$json[]=array( 
						"No"=>$rowfriend,  
						 "holdcharac_id"=>$myhdcharacter['holdcharac_id'], 
						 "charac_id"=>$myhdcharacter['charac_id'],  
						 "friend_userid"=>$dataFriend['friend_userid'], 
						 "friend_id"=>$dataFriend['friend_id'],   
						 ...
						 "friend_element"=>$myhdcharacter['charac_element'],  
