...
function new(params)
	...
	function scrollView:touch(event) 
	        ...
	        print(phase)
            print("1111111 1111 111 555666 :"..scrollView.y)
	        if( phase == "began" ) then
				print("23655:"..scrollView.y)
	...
	function scrollView:addScrollBar(r,g,b,a)
		...
		local scrollColorB = b or 200
		local scrollColorA = a or 255
						
		local viewPortH = screenH - self.top - self.bottom 
		local scrollH = viewPortH*self.height/(self.height*2 - viewPortH)		
		local scrollBar = display.newRoundedRect(viewableScreenW-8,0,5,scrollH,10)
