...
print("teamselectView.lua #ref: team_select.lau")
...
function new( imageSet, slideBackground, top, bottom ,pageTeam,pageItem)
    print("11111teamview pageItem,pageTeam:",pageItem,pageTeam)
    ...
    function touchListener (self, touch)
        ...
        elseif( self.isFocus ) then
            ...
            elseif ( phase == "ended" or phase == "cancelled"  ) then
                ...
                print("tttt 111 item_no",item_no,"team_no",imgNum)
