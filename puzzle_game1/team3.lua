...
function new()
    ...
    local imageName = "img/framCharacterIcon/as_cha_frm03.png"
    local imagePicture = "img/framCharacterIcon/as_cha_icon_test3001.png"
    ...
    for i = 3, 5, 1 do
        ...
        --local imageName = "as_cha_frm03.png"
    ...
    local message = display.newText("team 3/5", 0, 0, native.systemFontBold, 16)
