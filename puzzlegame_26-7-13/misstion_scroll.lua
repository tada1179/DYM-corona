...
--    function createImage()
        ...
        for i = 1, rowscharac, 1 do
            ...
            if i == rowscharac then
                ...
                NameMission = display.newText("name", screenW*.18, pointNameY,typeFont, 20)
                NameMission:setTextColor(255, 0, 255)
                NameMission.alpha = 0
                scrollView:insert(NameMission)

                txtbattle = display.newText("Battle ", screenW*.68, pointbattleY,typeFont, 20)
                txtbattle:setTextColor(200, 200, 200)
                txtbattle.alpha = 0
                scrollView:insert(txtbattle)

                txtstamina = display.newText("stamina ", screenW*.68, pointNameY,typeFont, 20)
                ...
                NameMission = display.newText(characterItem[i].mission_name, screenW*.18, pointNameY,typeFont, 20)
                NameMission:setTextColor(255, 0, 255)
                scrollView:insert(NameMission)

                txtbattle = display.newText("Battle "..characterItem[i].mission_amount, screenW*.68, pointbattleY,typeFont, 20)
                txtbattle:setTextColor(200, 200, 200)
                scrollView:insert(txtbattle)

                txtstamina = display.newText("stamina "..characterItem[i].mission_amount, screenW*.68, pointNameY,typeFont, 20)
                txtstamina:setTextColor(0, 0, 255)
                scrollView:insert(txtstamina)
            end
