...
--    characterAll = 2
    color = 5
    num = 3
--    num = math.random(1,characterAll)
...
--
    ...
    local image_sheet = {
        "img/sprite/Fire.png",
        "img/sprite/Earth.png",
        "img/sprite/Water.png",
        "img/sprite/Dark.png",
        "img/sprite/Light.png",
    }
    ...
    -- set point Effects = point Character ,character max = 4
--    local poinx = (display.contentWidth/characterAll+1)*num
--    local poiny = display.contentHeight*.2
    ...
    if color == 1 then
        ...
        myAnimation:setReferencePoint( display.BottomCenterReferencePoint)
        myAnimation.x = poinx
        myAnimation.y = poiny + display.contentHeight*.05
    elseif color == 2 then
        myAnimation = display.newSprite( sheet_light, sequenceData )
        myAnimation:setReferencePoint( display.BottomCenterReferencePoint)
        myAnimation.x = poinx
        myAnimation.y = poiny + display.contentHeight*.065
    elseif color == 3 then
        myAnimation = display.newSprite( sheet_light, sequenceData )
        myAnimation:setReferencePoint( display.BottomCenterReferencePoint)
        myAnimation.x = poinx
        myAnimation.y = poiny + display.contentHeight*.03
    elseif color == 4 then
        myAnimation = display.newSprite( sheet_light, sequenceData )
        myAnimation:setReferencePoint( display.BottomCenterReferencePoint)
        myAnimation.x = poinx
