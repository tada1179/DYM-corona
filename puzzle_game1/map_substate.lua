...
function scene:createScene( event )  
    ...
    local titleText = display.newImageRect( "img/text/CHAPTER_SELECT.png", display.contentWidth/1.8, display.contentHeight/17 )
    titleText:setReferencePoint( display.CenterReferencePoint )
    titleText.x = display.contentWidth /2
    titleText.y = display.contentHeight /3.12
