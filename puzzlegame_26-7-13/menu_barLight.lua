...
function newMenubutton()
    ...
    local imgDiamond = display.newImageRect("img/head/DIAMOND.png",screenW*.05,screenH*.03)--contentWidth contentHeight
    imgDiamond:setReferencePoint(display.TopLeftReferencePoint)-- setReferencePoint( display.TopLeftReferencePoint )
    imgDiamond.x,imgDiamond.y = screenW*.63,screenH*.115
    ...
    imgCoin.x,imgCoin.y = screenW*.63,screenH*.165
