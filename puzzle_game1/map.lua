...
function scene:createScene( event)
    ...
    btnMapForest = widget.newButton{
            default="img/background/forest_dark.png",
            over="img/background/forest_glow.png",
    ...
    btnMapMountain = widget.newButton{
            default="img/background/mountain_dark.png",
            over="img/background/mountain_glow.png",
