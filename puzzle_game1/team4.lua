...
function new()
    ...
    local imageName = "img/framCharacterIcon/as_cha_frm04.png"
    local imagePicture = "img/framCharacterIcon/as_cha_icon_test4001.png"
    ...
    for i = 3, 5, 1 do
       ...
       -- local imageName = "as_cha_frm04.png"
    ...
    local message = display.newText("team 4/5", 0, 0, native.systemFontBold, 16)
